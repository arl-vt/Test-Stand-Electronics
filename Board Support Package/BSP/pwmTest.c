...
//******** Variable ********************
volatile uint32_t pwmFreq = 10000; //10kHz
volatile double pwmPeriod;
volatile double pwmDuty;
volatile uint32_t dutyCycle = 10; //in percent
...
int main4(void)
{
   ...
   //Configure PWM Clock to match system 40/8 = 20 MhZ
