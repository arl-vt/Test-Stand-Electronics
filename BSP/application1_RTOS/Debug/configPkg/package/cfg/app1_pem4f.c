...
/* --> toggleBlueLED */
extern xdc_Void toggleBlueLED(xdc_UArg,xdc_UArg);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/TREC-EXO/Test-Stand-Electronics/BSP/application1_RTOS/Debug/configPkg/package/cfg/app1_pem4f");
...
ti_sysbios_knl_Task_Object__ ti_sysbios_knl_Task_Object__table__V[1] = {
    {/* instance#0 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg,xdc_UArg))((xdc_Fxn)toggleBlueLED)),  /* fxn */
        ((xdc_UArg)(0x3e8)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)0),  /* env */
        ((void*)0),  /* hookEnv */
...
#endif
#endif
const ti_sysbios_knl_Task_Handle toggleLED = (ti_sysbios_knl_Task_Handle)((ti_sysbios_knl_Task_Handle)&ti_sysbios_knl_Task_Object__table__V[0]);
