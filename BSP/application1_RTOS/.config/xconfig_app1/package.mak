...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccsv7/tools/compiler/ti-cgt-arm_17.3.0.STS
...
package/%.xdc.inc package/%_xconfig_app1.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_app1" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: app1.pem4f

-include package/cfg/app1_pem4f.mak
-include package/cfg/app1_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/app1_pem4f.dep
endif
app1.pem4f: package/cfg/app1_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
app1.pem4f package/cfg/app1_pem4f.c: .libraries,em4f
endif

package/cfg/app1_pem4f.c package/cfg/app1_pem4f.h package/cfg/app1_pem4f.xdl: override _PROG_NAME := app1.xem4f
package/cfg/app1_pem4f.c: package/cfg/app1_pem4f.cfg
package/cfg/app1_pem4f.xdc.inc: package/cfg/app1_pem4f.xdl
package/cfg/app1_pem4f.xdl package/cfg/app1_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/app1_pem4f.cfg
	-$(RM) package/cfg/app1_pem4f.dep
	-$(RM) package/cfg/app1_pem4f.c
	-$(RM) package/cfg/app1_pem4f.xdc.inc

clean,em4f::
	-$(RM) app1.pem4f
.executables,em4f .executables: app1.xem4f

app1.xem4f: |app1.pem4f

-include package/cfg/app1.xem4f.mak
app1.xem4f: package/cfg/app1_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/app1_pem4f.oem4f   package/cfg/app1_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
app1.xem4f: export C_DIR=
app1.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
app1.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

app1.test test,em4f test: app1.xem4f.test

app1.xem4f.test:: app1.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 app1.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.app1.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,app1.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
app1_pem4f.oem4f,copy : package/cfg/app1_pem4f.oem4f
app1_pem4f.sem4f,copy : package/cfg/app1_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_app1
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_app1.tar.dep
endif
package/rel/xconfig_app1/xconfig_app1/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_app1/xconfig_app1/package/package.rel.xml: package/build.cfg
package/rel/xconfig_app1/xconfig_app1/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_app1/xconfig_app1/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_app1.tar: package/rel/xconfig_app1.xdc.inc package/rel/xconfig_app1/xconfig_app1/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_app1.xdc.inc,package/rel/xconfig_app1.tar.dep)


release release,xconfig_app1: all xconfig_app1.tar
clean:: .clean
	-$(RM) xconfig_app1.tar
	-$(RM) package/rel/xconfig_app1.xdc.inc
	-$(RM) package/rel/xconfig_app1.tar.dep
