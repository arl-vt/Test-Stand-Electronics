...
linker.cmd: package/cfg/empty_min_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_min_pem4fcfg.cmd\)\"$""\"D:/TREC-EXO/Test-Stand-Electronics/RTOS/testProject/.config/xconfig_empty_min/\1\""' package/cfg/empty_min_pem4f.xdl > $@
