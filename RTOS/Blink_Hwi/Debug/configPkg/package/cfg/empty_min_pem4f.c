...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[7146];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/TREC-EXO/Test-Stand-Electronics/RTOS/Blink_Hwi/Debug/configPkg/package/cfg/empty_min_pem4f");
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1bea;
